  ...
  <div class="row">
    <div class="col-4 q-pr-md">
      <q-card flat bordered>
        <q-card-section class="text-center">
          <div class="q-pb-sm text-body1">{{ showItem.Professer+ ' ' + showItem.System }}</div>
        ...
        <q-card-section>
          <q-list padding class="rounded-borders">
            <q-item>
              ...
              <q-item-section side>{{ showItem.Professer }}</q-item-section>
            </q-item>
            <q-item>
    ...
    <div class="col q-pr-sm">
      <div v-for="(item,i) in list" :key="item.System" class="q-pb-xs">
        <q-list dense padding class="rounded-borders bg-red" v-if="item.Professer === 'AMD'">
          <q-item clickable v-ripple @click="show(item,i)">
            <q-item-section>{{item.Professer + ' ' + item.System}}</q-item-section>
          </q-item>
        </q-list>
    ...
    <div class="col q-pl-sm">
      <div v-for="(item,i) in list" :key="item.System" class="q-pb-xs">
        <q-list dense padding class="rounded-borders bg-blue" v-if="item.Professer === 'Intel'">
          <q-item clickable v-ripple @click="show(item,i)">
            <q-item-section>{{item.Professer + ' ' + item.System}}</q-item-section>
          </q-item>
        </q-list>
